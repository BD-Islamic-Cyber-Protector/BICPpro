...
\x1b[0;33m ---------------------------------------------
    ...
    \033[2;95m d8888b. d888888b  .o88b. d8888b.    \033[1;97m
    \033[2;95m 88  `8D   `88'   d8P  Y8 88  `8D        \033[1;97m
    \033[2;96m 88oooY'    88    8P      88oodD'      \033[1;97m
    \033[2;96m 88~~~b.    88    8b      88~~~       \033[1;97m
    \033[2;94m 88   8D   .88.   Y8b  d8 88          \033[1;97m
    \033[2;94m Y8888P' Y888888P  `Y88P' 88            \033[1;97m
    \033[1;97m---------------------------------------------------------
...
def cek_ttl_cp(uid, pw):
	...
	try:
		...
		with requests.Session() as ses:
			...
			open("CP/%s.txt"%(tBICP),"a").write(" + %s|%s|%s %s %s\n"%(uid, pw, day, month, year))
	...
	try:
		...
		for pw in pwx:
			...
			if "session_key" in send.text and "EAAA" in send.text:
				...
				print("\r\033[0;94m[BICP] %s|%s|%s\033[0;97m"%(uid, pw, send.json()["access_token"]))
